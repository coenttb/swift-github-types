          ...
          URLRouting.Query {
            Optionally {
              Parse(.memberwise(GitHub.Repositories.List.Request.init)) {
                Optionally {
                  Field("visibility") {
                    Parse(.string.representing(GitHub.Repositories.List.Request.Visibility.self))
                  }
                }
                Optionally {
                ...
                Optionally {
                  Field("type") {
                    Parse(.string.representing(GitHub.Repositories.List.Request.RepoType.self))
                  }
                }
                Optionally {
                  Field("sort") {
                    Parse(.string.representing(GitHub.Repositories.List.Request.Sort.self))
                  }
                }
                Optionally {
                  Field("direction") {
                    Parse(.string.representing(GitHub.Repositories.List.Request.Direction.self))
                  }
                }
                Optionally {
